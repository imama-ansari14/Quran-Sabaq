...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" ref={sectionRef} className="py-20 bg-gray-50 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`mb-12 transform transition-all duration-1000 delay-200 ${
          ...
          <div className={`bg-gradient-to-br ${testimonials[activeIndex].gradient} rounded-3xl p-8 md:p-12 text-white shadow-2xl relative overflow-hidden`}>
        ...
        {/* Bottom Stats */}
        <div className={`mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 transform transition-all duration-1000 delay-1000 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
          {[
