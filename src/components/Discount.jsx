...
const Discount = () => {
  const discounts = [
    {
      text: "On Annual payment you save 20%",
      icon: <Star className="w-5 h-5 fill-yellow-400 text-yellow-400" />,
    },
    {
      text: "On Six months payment you save 10%",
      icon: <Zap className="w-5 h-5 text-blue-600" />,
    },
    {
      text: "On Quarterly Payment you save 5%",
  ...
  const referrals = [
    {
      text: "On one student referral you get 15% discount",
      icon: <CheckCircle2 className="w-6 h-6 text-blue-600" />,
    },
    {
      text: "On two students referral you get 25% discount",
        ...
        <div className="group relative overflow-hidden rounded-3xl bg-white p-1 transition-all duration-500 hover:shadow-2xl">
          ...
          <div className="relative h-full bg-white rounded-[1.4rem] p-8 md:p-10 flex flex-col">
            <div className="flex items-center gap-5 mb-6">
              <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-white border-2 border-blue-600 text-blue-600 shadow-md bg-gradient-to-br from-blue-600 to-purple-700 text-white transition-all duration-500">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed font-medium">
              Quran Sabaq offers attractive referral discounts. Join our mission
              to spread Quranic knowledge and enjoy exclusive benefits.
            </p>
            ...
            <div className="space-y-4">
              {referrals.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center gap-4 p-5 rounded-2xl bg-gray-50 border border-transparent group-hover:border-blue-100 group-hover:bg-white transition-all duration-300 shadow-sm"
                >
